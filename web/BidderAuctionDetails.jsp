		...
		<div class="modal-dialog">
			...
			<div class="modal-body">
				<form action="" method="">
					...
					Category: <input type="text" value="<%=b.get(5) %>" class="form-control"/>
					Description: <input type="text" value="<%=b.get(2) %>" class="form-control"/>
					Initial Amount: <input type="text" value="<%=b.get(3) %>" class="form-control"/>
					Auction Date<input type="text" value="<%=b.get(4) %>" class="form-control"/>
